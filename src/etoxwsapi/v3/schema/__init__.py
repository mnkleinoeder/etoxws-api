...
class SchemaDefinition(object):
    ...
    classdocs
    '''
    id_base =	"http://etoxsys.eu/etoxwsapi/v3/schema/%(name)s#"
...
def _init_registry():
    ...
    for name in flist :
        ...
        try:
            mod = __import__('etoxwsapi.v3.schema.%s'%(module_name), fromlist=['etoxwsapi.v3.schema'])
...
def create_result_endpoint(data_type):
    ...
    from etoxwsapi.v3.schema import result_endpoint
